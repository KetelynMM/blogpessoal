...
public class Postagem {
	...
	@NotBlank(message = "O Atributo título é obrigatório!")// noblank é exclusivo para string
	...
	@UpdateTimestamp //localdatetime mais atualizada no java e updatetimestamp atualiza as informações
